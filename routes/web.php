...
Route::get('/tim-kiem-gia', [ProductController::class, 'search_price']);
...
//Route::get('/don-hang', [CheckoutController::class, 'don_hang']);
...
Route::post('/import-csv', [CheckoutController::class, 'import_csv']);
Route::post('/export-csv', [CheckoutController::class, 'export_csv']);